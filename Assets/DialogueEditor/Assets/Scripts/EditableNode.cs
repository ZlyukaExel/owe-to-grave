            ...
            if (conversation.Version < (int)eSaveVersion.V1_03)
            {
                if (this.TMPFont == null)
                {
                    if (!string.IsNullOrEmpty(TMPFontGUID))
                    {
                        ...
                        this.TMPFont = (TMPro.TMP_FontAsset)
            ...
            if (conversation.Version < (int)eSaveVersion.V1_03)
            {
                if (this.Audio == null)
                {
                    if (!string.IsNullOrEmpty(AudioGUID))
                    {
                        ...
                        this.Audio = (AudioClip)
                            UnityEditor.AssetDatabase.LoadAssetAtPath(path, typeof(AudioClip));
                    }
                }
                ...
                if (this.Icon == null)
                {
                    if (!string.IsNullOrEmpty(IconGUID))
                    {
                        ...
                        this.Icon = (Sprite)
                            UnityEditor.AssetDatabase.LoadAssetAtPath(path, typeof(Sprite));
                    }
                }
            }
#endif
