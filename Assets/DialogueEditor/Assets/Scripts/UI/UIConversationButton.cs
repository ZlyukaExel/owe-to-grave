...
{
    public class UIConversationButton : MonoBehaviour, ISelectHandler, IDeselectHandler
    {
        ...
        [SerializeField]
        private Image OptionBackgroundImage = null;
        ...
        public void SetHovering(bool selected)
        {
            if (
                selected
                && (m_hoverState == eHoverState.animatingOn || m_hoverState == eHoverState.idleOn)
            )
            {
                return;
            }
            if (
                !selected
                && (m_hoverState == eHoverState.animatingOff || m_hoverState == eHoverState.idleOff)
            )
            {
                return;
            }
