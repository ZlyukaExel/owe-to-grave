...
namespace DialogueEditor
{
    ...
    {
        private const string PREVIEW_TEXT =
            "Placeholder text. This image acts as a preview of the in-game GUI.";
        ...
        SerializedProperty OnDialogChangedProperty;
        SerializedProperty OnOptionsAppearedProperty;
        SerializedProperty OnDialogStartedProperty;
        SerializedProperty OnDialogEndedProperty;
        ...
        private void OnEnable()
        {
            ...
            OnDialogChangedProperty = serializedObject.FindProperty("OnDialogChanged");
            OnOptionsAppearedProperty = serializedObject.FindProperty("OnOptionsAppeared");
            OnDialogStartedProperty = serializedObject.FindProperty("OnConversationStarted");
            OnDialogEndedProperty = serializedObject.FindProperty("OnConversationEnded");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(OnDialogChangedProperty);
            EditorGUILayout.PropertyField(OnOptionsAppearedProperty);
            EditorGUILayout.PropertyField(OnDialogStartedProperty);
            EditorGUILayout.PropertyField(OnDialogEndedProperty);
        ...
        private void RenderPreviewImage(ConversationManager t)
        {
            ...
            {
                boxRect = new Rect(
                    contextRect.x + contextRect.width * 0.125f,
                    contextRect.y + 10,
                    width,
                    height
                );
            ...
            Rect optionRect = new Rect(
                option_x,
                boxRect.y + boxRect.height + OPTION_BUFFER,
                option_wid,
                OPTION_HEIGHT
            );
