...
namespace Mirror.Discovery
{
        ...
        where Response : NetworkMessage
    {
        ...
        async Task ReceiveRequestAsync(UdpClient udpClient)
        {
            ...
            using (
                NetworkReaderPooled networkReader = NetworkReaderPool.Get(udpReceiveResult.Buffer)
            )
            {
        ...
        public void SendByIp(string serverIP, int port)
        {
