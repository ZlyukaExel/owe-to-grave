...
namespace Mirror
{
    public class NetworkConnectionToClient : NetworkConnection
    {
        ...
        // <clienttime, snaps>
        readonly SortedList<double, TimeSnapshot> snapshots =
        ...
        internal ExponentialMovingAverage _rtt = new ExponentialMovingAverage(
            NetworkTime.PingWindowSize
        );
        ...
        public NetworkConnectionToClient(
