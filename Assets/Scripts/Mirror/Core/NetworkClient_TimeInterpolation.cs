...
namespace Mirror
{
    public static partial class NetworkClient
    {
        ...
        [Obsolete(
            "NeworkClient.dynamicAdjustment was moved to NetworkClient.snapshotSettings.dynamicAdjustment"
        )]
        public static bool dynamicAdjustment => snapshotSettings.dynamicAdjustment;

        // DEPRECATED 2024-10-08
        [Obsolete(
            "NeworkClient.dynamicAdjustmentTolerance was moved to NetworkClient.snapshotSettings.dynamicAdjustmentTolerance"
        )]
